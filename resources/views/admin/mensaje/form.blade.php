<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $mensaje?->nombre) }}" id="nombre" placeholder="Nombre">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_user" class="form-control @error('id_user') is-invalid @enderror" value="{{ old('id_user', $mensaje?->id_user) }}" id="id_user" placeholder="Id User">
