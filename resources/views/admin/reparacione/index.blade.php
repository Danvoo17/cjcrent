                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('reparaciones.destroy',$reparacione->id_reparacion) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('reparaciones.show',$reparacione->id_reparacion) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('reparaciones.edit',$reparacione->id_reparacion) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
