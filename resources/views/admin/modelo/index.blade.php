                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('modelos.destroy',$modelo->id_modelo) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('modelos.show',$modelo->id_modelo) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Ver') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('modelos.edit',$modelo->id_modelo) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                    @csrf
                                                    @method('DELETE')
