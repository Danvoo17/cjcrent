                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Progresos</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">migracion del server <span
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Agregue algunas ilustraciones svg de calidad a su proyecto, cortesía de <a
                                            target="_blank" rel="nofollow" href="https://undraw.co/">unDraw</a>, a
                                        colección constantemente actualizada de hermosas imágenes svg que puedes usar
                                        ¡completamente gratis y sin atribución!</p>
                                    <a target="_blank" rel="nofollow" href="https://undraw.co/">Explorar ilustraciones en
                                        unDraw &rarr;</a>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>SB Admin 2 hace un uso extensivo de las clases de utilidad Bootstrap 4 para reducir
                                        Inflación de CSS y bajo rendimiento de la página. Las clases CSS personalizadas se utilizan para crear
                                        componentes personalizados y clases de utilidades personalizadas.</p>
                                    <p class="mb-0">Antes de trabajar con este tema, debe familiarizarse con el
                                        Marco Bootstrap, especialmente las clases de utilidad.</p>
                                </div>
                            </div>
