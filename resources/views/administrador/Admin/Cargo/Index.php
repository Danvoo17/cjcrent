    ...
    <table border="1">
        ...
        if ($total != 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <td>
                <button type='button' href='Update.php?rn=". $row['id_cargo']. "'>Editar</button>
                <button type='button' href='Borrar.php?rn=". $row['id_cargo']. "'>Borrar</button>
              </td> 
              </tr>";
            }
        }
